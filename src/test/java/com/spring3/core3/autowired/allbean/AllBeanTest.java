package com.spring3.core3.autowired.allbean;

import com.spring3.core3.AutoAppConfig;
...
public class AllBeanTest {
    ...
    static class DiscountService {
        ...
        public int discount(Member member, int price, String discountCode) {
            ...
            return discountPolicy.discount(member,price);   // -> Map, List를 이용해 다형성 코드를 만들 수 있음
        }
    }
}
